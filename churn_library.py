...
def perform_eda(df):
    ...
    plt.axes().set_ylabel('Num. of customers')
    plt.axes().set_title('Churn analysis')
    plt.tight_layout()
    plt.savefig('./images/eda/churn_hist.png')

    plt.figure(figsize=(20, 10))
    plt.hist(df['Customer_Age'])
    plt.axes().set_xlabel('Customer age')
    plt.axes().set_ylabel('Num. of customers')
    plt.axes().set_title('Customer age analysis')
    plt.tight_layout()
    ...
    plt.axes().set_title('Marital status analysis')
    plt.tight_layout()
